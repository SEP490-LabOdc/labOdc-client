                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        <div className="lg:w-1/2">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link to='/company-register' className="bg-[var(--color-brand-orange)] hover:bg-[var(--color-brand-orange)]/90 text-white px-8 py-4 rounded-md font-semibold text-lg transition-colors shadow-lg">
                                    Đăng ký doanh nghiệp
                                </Link>
                                <button className="border-2 border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground px-8 py-4 rounded-md font-semibold text-lg transition-colors">
                                    Liên hệ tư vấn
                                </button>
                            </div>
                        </div>
            ...
            <section className="py-20">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center p-6 rounded-md border border-border hover:shadow-lg hover:border-secondary/30 transition-all">
                            <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        ...
                        <div className="text-center p-6 rounded-md border border-border hover:shadow-lg hover:border-accent/30 transition-all">
                            <div className="w-16 h-16 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <TrendingUp className="w-8 h-8 text-accent" />
                            </div>
            ...
            <section className="py-20 bg-gradient-to-r from-muted/50 to-primary/5">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="bg-card p-6 rounded-md shadow-md hover:shadow-lg transition-shadow border-l-4 border-secondary">
                        ...
                        <div className="bg-card p-6 rounded-md shadow-md hover:shadow-lg transition-shadow border-l-4 border-accent">
                        ...
                        <div className="bg-card p-6 rounded-md shadow-md hover:shadow-lg transition-shadow border-l-4 border-primary">
            ...
            <section className="py-20 bg-muted/50">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-card p-6 rounded-md shadow-md hover:shadow-lg transition-shadow border-t-4 border-secondary">
                            <div className="flex items-center mb-4">
                                <img src="/api/placeholder/50/50" alt="Company Logo" className="w-12 h-12 rounded-md mr-3" />
                                <div>
                        ...
                        <div className="bg-card p-6 rounded-md shadow-md hover:shadow-lg transition-shadow border-t-4 border-accent">
                            <div className="flex items-center mb-4">
                                <img src="/api/placeholder/50/50" alt="Company Logo" className="w-12 h-12 rounded-md mr-3" />
                                <div>
