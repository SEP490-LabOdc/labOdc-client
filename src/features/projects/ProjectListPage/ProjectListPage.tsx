...
import { Search, Filter, Clock, DollarSign, Users, Star, Send } from "lucide-react"
                ...
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      {Math.floor(Math.random() * 10) + 1} proposals
                    </div>
                  </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <p className="text-sm font-medium text-[#264653]">Company ID: {project.companyId.slice(0, 8)}...</p>
                    </div>
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {project.skills.map((skill) => (
                                    <Badge key={skill.id} className="bg-[#2a9d8f] text-white">
                                      {skill.name}
                                    </Badge>
                                  ))}
                                </div>
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  <h4 className="font-semibold mb-1 text-[#264653]">Start Date</h4>
                                  <p className="text-sm text-gray-600">{new Date(project.startDate).toLocaleDateString()}</p>
                                </div>
                                <div>
                                  <h4 className="font-semibold mb-1 text-[#264653]">End Date</h4>
                                ...
                                <div>
                                  <h4 className="font-semibold mb-1 text-[#264653]">Status</h4>
                                  <Badge className="bg-[#e9c46a] text-[#264653]">{project.status}</Badge>
                                </div>
                              </div>
                            </div>
