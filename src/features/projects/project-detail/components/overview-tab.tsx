...
export const ProjectOverviewTab: React.FC<ProjectOverviewTabProps> = ({ projectData }) => {
  ...
  const handleAddMembers = (selectedUsers: any[]) => {
    console.log("Các thành viên được thêm:", selectedUsers);
    // TODO: Gọi API để thêm các user này vào dự án
  };
          ...
          <div className="space-y-5 pt-4 border-t">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1 flex flex-wrap items-center gap-2">
                ...
                <Button
                  variant="ghost" size="sm" className="text-gray-600 hover:text-gray-900 text-sm p-1 h-auto"
                >
                  <Plus className="h-4 w-4 mr-1" />
                  Thêm mới
                </Button>
